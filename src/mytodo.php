...
// Query untuk mengambil daftar tugas yang terkait dengan pengguna yang sedang login
...
<body class="font-[Poppins] bg-slate-200">
    <section class="flex ">
        ...
        <div class="dashboard-nav bg-white flex justify-between items-center w-full -mt-2 p-4 rounded-[18px] animate__animated animate__fadeIn">
            ...
            <div class="">
                <div id="modal" class="modal hidden fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50">
                    <div class="w-full h-screen flex justify-center items-center">
                        <div class="bg-white border border-slate-100 p-6 w-[500px] h-[450px] z-[100] top-[300px] left-1/2 shadow-lg rounded-lg animate__animated animate__fadeIn">
                            <div class="flex justify-between items-center">
                                <h1 class="text-2xl font-bold mb-8">Ayo buat to-do list kamu ✍</h1>
                                <button onclick="closeModal()" class="mb-8 text-xl font-bold">X</button>
                            </div>
                            
                            <form id="taskForm" action="tambah_tugas.php" method="POST">
                                <h2 class="text-base font-semibold mb-2 rounded-md">Judul Todo</h2>
                                <div class="mb-4">
                                    <input type="text" name="task_name" id="task_name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required placeholder="Judul Todo">
                                </div>
                                <h2 class="text-base font-semibold mb-2 rounded-md">Tanggal & jam</h2>
                                <div class="mb-4">
                                    <input type="datetime-local" name="tanggal" id="tanggal" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                                </div>
                                <h2 class="text-base font-semibold mb-2 rounded-md">Deskripsi</h2>
                                <div class="mb-4">
                                    <textarea name="task_description" id="task_description" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required placeholder="Deskripsi"></textarea>
                                </div>
                                <div class="flex justify-center items-center mt-4">
                                    <button type="submit" class="bg-[#5400DE] w-full hover:bg-purple-500 hover:shadow-lg hover:shadow-purple-600 transition-all text-white font-bold py-2 px-9 rounded">Kirim</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    <li class="p-4" >
                    <a href="mytodo_detail.php? id=<?= $row['task_id']?>">
                        <div class="w-full h-[100px] bg-white rounded-xl shadow-xl flex items-center hover:shadow-2xl hover:bg-slate-50 animate__animated animate__fadeIn ">
                            <div class="flex items-center justify-between px-2 py-5 sm:px-6 w-full">
                                ...
                                <div>
                                    <form method="POST" action="delete_todo.php">
                                        ...
                                        <button type="submit" class="text-red-500"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" class="text-3xl" viewBox="0 0 24 24"><path fill="currentColor" d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6zM19 4h-3.5l-1-1h-5l-1 1H5v2h14z"/></svg></button>
                                    </form>
                                </div>
                            </div>
                        </div>
