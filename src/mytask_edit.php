...
// if(isset($_GET['id'])) {
//     $id = $_GET['id'];
//     $query = "SELECT * FROM task_manager WHERE id = $id";
//     $result = mysqli_query($conn, $query);
...
<body class="font-[Poppins] bg-slate-200 ">
    <section class="flex ">
        ...
        <div id="Content"
            ...
            <div class="flex flex-col gap-[30px]">
                ...
                <div class="content-header flex justify-between items-center">
                    <div class="flex gap-3 items-center">
                        <button id="modalButton" onclick="openModal()"
                            class="bg-[#6E15FF] hover:bg-sky-400 text-white font-semibold text-sm py-3 px-4 rounded-lg m-4 animate__animated animate__fadeIn">
                            Tambah Tugas
                        </button>
                    </div>
                    <div>
                ...
                <div class="flex flex-col gap-[30px]">
                    <table id="taskTable"
                        class="w-full text-base text-left rtl:text-right text-gray-700 dark:text-gray-400 rounded-lg animate__animated animate__fadeIn">
                        <thead
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td>
                                    <button id="EditmodalButton" onclick="openEditModal(event)"> 
                                        <a href="? id=<?= $task['id']?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline edit-task" >Edit</a>
                                    </button> 
                                    
                                    <a href="hapustask.php? id=<?= $task['id']?>"class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Hapus</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <!-- EDIT MODAL -->
        <div id="editModal" class="modal  fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 ">
        <!-- Konten Modal -->
                                ...
                                <div class="flex justify-around">
                                    <div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input class="shadow appearance-none border rounded w-72  py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="<?= $tampil['start_time']?>" id="start_time" name="start_time" type="date" required>
                                        </div> 
                                    </div>
                                    <div>
                                        <div class="mb-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input class="shadow appearance-none border rounded w-72  py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="end_time" name="end_time" value="<?= $tampil['end_time']?>" type="date" required>
                                        </div>
                                    </div>
                                </div>
    ...
    rows.forEach(function(row) {
        var taskName = row.querySelector("td:nth-child(2)").textContent.toLowerCase();
